...
import com.fastcampus.pass.passbatch.config.BatchConfigTest;
import com.fastcampus.pass.passbatch.repository.pass.PassEntity;
import com.fastcampus.pass.passbatch.repository.pass.PassRepository;
import com.fastcampus.pass.passbatch.repository.pass.PassStatus;
...
@SpringBootTest
@ActiveProfiles("test")
@ContextConfiguration(classes = {ExpirePassesJobConfig.class, BatchConfigTest.class})
